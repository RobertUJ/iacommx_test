...
CREATE TABLE public.solicitudes (
    ...
    grimoire_type character varying(50) DEFAULT 'none'::character varying,
    grimoire_description text DEFAULT 'none'::text,
    clover_leaves integer DEFAULT 0,
...
--
-- Name: solicitudes solicitudes_email_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.solicitudes
    ADD CONSTRAINT solicitudes_email_key UNIQUE (email);
